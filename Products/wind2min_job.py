...
def _job(now):
    ...
    fn = "SURF_WIND_2MIN_" + timestr + "_STREAM.png"
    ...
    if pftp.connect():
        if pftp.upload(upload_path='SURF/WIND/2MIN/', local_path=source_path, upload_file=fn):
            is_success = True
        pftp.dis_connect()
    if is_success:
    ...
    fn = "SURF_WIND_2MIN_" + timestr + "_BARB.png"
